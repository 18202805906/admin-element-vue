  ...
  >
    ...
    >
      <el-button
        type="primary"
        size="small"
        class="btn_check el-icon-search"
        @click="checkHandle"
        :loading="loading"
      >查询</el-button>
      <el-button v-if="reset" class="btn_reset el-icon-refresh" size="small" @click="resetHandle">重置</el-button>
      <el-button v-if="add" class="el-icon-plus" type="primary" size="small" @click="addHandle">新增</el-button>
    </el-form-item>
  </el-form>
</template>

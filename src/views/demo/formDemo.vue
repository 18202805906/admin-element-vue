    ...
    return {
      ...
      formOpts: {
        ...
        fieldList: [
          ...
          { label: '头像', value: 'avatar', slotName: 'avatar', className: 't-form-block' },
          ...
          { label: '爱好', value: 'hobby', type: 'checkbox', comp: 'el-checkbox-group', list: 'hobbyList', event: 'checkbox', widthSize: '2' },
        ...
        operatorList: [
          { label: '提交', type: 'primary', fun: this.submitForm, size: 'small' },
          { label: '重置',  fun: this.resetForm , size: 'small'},
          { label: '清除校验', type: 'danger', fun: this.clearValidate , size: 'small'}
        ],
        // 相关列表
        listTypeInfo: {
          hobbyList: [
